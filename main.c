...
#pragma config(Motor,  port6,           launcherL1,    tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port7,           launcherL2,    tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port8,           launcherR1,    tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port9,           launcherR2,    tmotorVex393_MC29, openLoop, reversed)
